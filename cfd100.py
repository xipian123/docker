...
# 请定时为59秒，程序会自动计算延迟时间
# 这里填cookie
cookie = "pt_pin=xipian_123_m;pt_key=AAJhflzyADCaVYWBR4Oh7MFdc6d4bT5gf4S6PoEZgm94v2cGMIGa_4K0V29uEZQ1XV4s-48sT20;&pt_pin=jd_491d0c6e1d751;pt_key=AAJhjRrIADDkelSulo3HjiFsUt9Wfu58CtqwoNlgrOkXrrlVGMg2qegfQ0M4XSx3s5LWKwx09OA;"
# 这里输入发送时间间隔 单位：s(秒)
nterval_time = 0.5
